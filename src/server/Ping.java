		...
		while (true) {
            ...
            while (i.hasNext()) {
				try{
					...
					nickJogadores.remove(pl.getPlayerName().trim());
					System.out.println("Player foi removido2: "+pl.getPlayerName().trim());
				} catch (SocketTimeoutException ex){
					i.remove();
					listaAtualizada.remove(pl);
					nickJogadores.remove(pl.getPlayerName().trim());
					System.out.println("Player foi removido: "+pl.getPlayerName().trim());
